...
public class BoundsPopupMenuListener implements PopupMenuListener {
	...
	public BoundsPopupMenuListener(boolean scrollBarRequired,
			boolean popupWider, int maximumWidth, boolean popupAbove) {
	...
	protected JScrollPane getScrollPane(BasicComboPopup popup) {
		JList list = popup.getList();
		Container c = SwingUtilities
				.getAncestorOfClass(JScrollPane.class, list);
	 ...
	 */
	@SuppressWarnings("rawtypes")
	protected int getScrollBarWidth(BasicComboPopup popup,
